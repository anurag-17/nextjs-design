    ...
    <>
      <section className="py-[30px] lg:py-[70px]">
        <div className="container mx-auto">
          <div className="">
            <h3 className="text-black font-['Red_Hat_Display'] text-[24px] md:text-[35px] font-bold leading:[30px] md:leading-[45px] text-center px-4">
            ...
            <div className="md:pt-[70px] pt-[30px] flex  flex-wrap lg:flex-row lg:flex-nowrap  gap-x-3 gap-y-6  md:px-0 px-4 justify-center ">
              {cardItems.map((items) => (
                  ...
                  >
                    ...
                    <img src="/svg/social/instagram.svg" alt="loading."  className=""/>
                    </div>
                </div>
              ))}
            </div>
